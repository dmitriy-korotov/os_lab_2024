...
#define SHW_ADR(ID, I) (printf("ID %s \t is at virtual address: %10p\n", ID, &I))
...
int main() {
  ...
  printf("\nAddress etext: %10p \n", &etext);
  printf("Address edata: %10p \n", &edata);
  printf("Address end  : %10p \n", &end);
